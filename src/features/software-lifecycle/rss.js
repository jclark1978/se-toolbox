export function parseSoftwareLifecycleRssText(xmlText) {
  ...
  const feedTitle = cleanupText(matchTag(channel, "title")) || "Fortinet Product Lifecycle (Software)";
  ...
  itemMatches.forEach((itemXml, index) => {
    ...
    rows.push({
      ...
      endOfEngineeringSupportDate: fields.endOfEngineeringSupportDate,
...
function extractDescriptionFields(description) {
  return {
    releaseDate: extractLabeledValue(description, "Release"),
    endOfEngineeringSupportDate: extractLabeledValue(description, "End of Engineering Support"),
